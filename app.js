...
const COL=Object.freeze({
  ...
  correctCount:16,wrongCount:17,questionCount:18
    ...
    const practiceJapaneseLabel=document.getElementById('practiceJapaneseLabel');
    const practiceEnglishLabel=document.getElementById('practiceEnglishLabel');
    ...
    const practiceMeaningMeta=document.getElementById('practiceMeaningMeta');
    ...
    const renderPracticeQuestion=()=>{
      ...
      practiceMeaningMeta.textContent=`${part}・${meaningNumber}`;
      practiceMeaningMeta.className=`practice-meta-chip practice-meaning-meta ${rankTone}`.trim();
      practiceJapaneseLabel.textContent=`${exampleNumber}・日本語`;
      practiceEnglishLabel.textContent=`${exampleNumber}・英語`;
